...
public class AutoOracleExport {

    private static final Logger LOG = LoggerFactory.getLogger(AutoOracleExport.class);
    ...
    public static void main(String[] arg){
        AutoOracleExport autoApplicationBuild = new AutoOracleExport();
        try{
